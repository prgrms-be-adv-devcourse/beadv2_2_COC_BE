...
public class AddressController {
	...
	// 주소 목록 조회
    @GetMapping("/profile")
    public ResponseEntity<ApiResponse<AddressListResponse>> getProfileAddresses(@AuthenticationPrincipal CustomMember member) {
		
        AddressListResponse response = addressService.getProfileAddresses(member.getMemberId());
