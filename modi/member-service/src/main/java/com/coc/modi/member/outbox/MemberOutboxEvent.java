...
public class MemberOutboxEvent extends BaseEntity {
	...
	private MemberOutboxEventType eventType;
	...
	private MemberOutboxEvent(String aggregateType,
							  Long aggregateId,
							  MemberOutboxEventType eventType,
							  String payload) {
		...
		this.status = MemberOutboxStatus.PENDING;
		this.retryCount = 0;
	}
	
	public static MemberOutboxEvent create(String aggregateType,
										   Long aggregateId,
										   MemberOutboxEventType eventType,
										   String payload) {
		
		return new MemberOutboxEvent(aggregateType, aggregateId, eventType, payload);
	}
