...
INSERT INTO gateway_endpoint_permission (method, path_pattern, roles) VALUES ('GET', '/support-service/api/deliveries/{deliveryId}', 'MEMBER,SELLER');
INSERT INTO gateway_endpoint_permission (method, path_pattern, roles) VALUES ('GET', '/support-service/api/deliveries/rental-items/{rentalItemId}', 'MEMBER,SELLER');
...
INSERT INTO gateway_endpoint_permission (method, path_pattern, roles) VALUES ('POST', '/seller-service/api/chat/rooms', 'MEMBER,SELLER');
INSERT INTO gateway_endpoint_permission (method, path_pattern, roles) VALUES ('GET', '/seller-service/api/chat/rooms/{roomId}', 'MEMBER,SELLER');
...
INSERT INTO gateway_endpoint_permission (method, path_pattern, roles) VALUES ('POST', '/seller-service/api/settlements/sellers/self/{sellerSettlementId}/cancel', 'SELLER');
